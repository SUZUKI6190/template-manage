...
<?php endif; ?>
<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/onecol.css" type="text/css" media="screen,print" />
...
<script src="<?php bloginfo('template_directory'); ?>/lp_img/button01.js"></script>
<!--[if lt IE 9]>
